...
export default function Hikes() {
  ...
  const allTimeMetrics = useActivitiesStore(hikeAllTimesMetrics);
  const pastFourWeeksMetrics = useActivitiesStore(hikeFilteredByDateMetrics(DateSection.PastFourWeeks));
  const calendarYearMetrics = useActivitiesStore(hikeFilteredByDateMetrics(DateSection.CalendarYear));
  ...
  return (
    <PageContainer title="Hiking" athleteId={athlete} loading={loading}>
      {/* Best hikes ever */}
      <PageSection title="Best hikes ever" icon="trophy">
        <StatsSection>
          {loading ? (
            <>
